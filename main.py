...
def main():
    ...
    set_seed(args.seed)
    config = Config(args.train, args.test, args.text_encoder, args.ensemble_num, args.word_embedding_dim, args.hidden_dim, args.num_hidden_layers, args.num_attention_heads, args.intermediate_size, args.no_pretrain, args.seed, args.cpu)
